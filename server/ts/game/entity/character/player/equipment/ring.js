...
var Ring = /** @class */ (function (_super) {
    ...
    function Ring(name, id, count, ability, abilityLevel) {
        var _this = _super.call(this, name, id, count, ability, abilityLevel) || this;
        _this.ringLevel = items_1["default"].getRingLevel(name);
        return _this;
    }
    Ring.prototype.getBaseAmplifier = function () {
        return 1.0 + this.ringLevel / 100;
    };
    Ring.prototype.getType = function () {
        return modules_1["default"].Equipment.Ring;
    };
    return Ring;
}(equipment_1["default"]));
