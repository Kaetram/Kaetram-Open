	...
	load() {
	    ...
	    this.roamingInterval = setInterval(() => {
	        ...
	        if (!this.mob.dead) {
	            ...
	            const newX = this.spawnLocation[0] + Utils.randomInt(-this.maxRoamingDistance, this.maxRoamingDistance);
	                const newY = this.spawnLocation[1] + Utils.randomInt(-this.maxRoamingDistance, this.maxRoamingDistance);
	                const distance = Utils.getDistance(this.spawnLocation[0], this.spawnLocation[1], newX, newY);
