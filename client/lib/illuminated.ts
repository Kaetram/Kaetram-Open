...
(function(cp: any) {
    ...
    /**
     ...
     rendered onto it.
     **/
    cp.Light.prototype._getVisibleMaskCache = () => {
     ...
     **/
    cp.Light.prototype._getHashCache = () => {
    ...
    /**
     ...
     of the boundary.
     **/
    cp.OpaqueObject.prototype.bounds = () => {
    ...
    /**
     ...
     @return {String} The hash key.
     **/
    cp.Lamp.prototype._getHashCache = () => {
        return [
            this.color,
            this.distance,
            this.diffuse,
    ...
    cp.Lamp.prototype._getGradientCache = function(center) {
        ...
        const g = cache.ctx.createRadialGradient(
            center.x,
            center.y,
            0,
            d,
    ...
    */
    ...
    function getTan2(radius, center) {
        let epsilon = (getTan2 as any).epsilon || 1e-6, // constant
            x0,
            y0,
            len2,
            soln,
    ...
    /**
     ...
     of the boundary.
     **/
    cp.DiscObject.prototype.bounds = () => {
        return {
            topleft: new cp.Vec2(
    ...
    /**
     ...
     of the boundary.
     **/
    cp.PolygonObject.prototype.bounds = () => {
     ...
     **/
    cp.RectangleObject.prototype.syncFromTopleftBottomright = () => {
    ...
    /**
     ...
     @method syncFromAB
     **/
    cp.LineObject.prototype.syncFromAB = () => {
     ...
     **/
    cp.Lighting.prototype.getCanvas = () => {
    ...
    function createCanvasAnd2dContext(id, w, h) {
        ...
        const canvas: any = document.getElementById(iid);
     ...
     **/
    const extractColorAndAlpha = (cp.extractColorAndAlpha = (() => {
        //let ctx = createCanvasAnd2dContext('grgba', 1, 1);
        const canvas = document.createElement('canvas');
        canvas.width = canvas.height = 1;
        const ctx = canvas.getContext('2d');
