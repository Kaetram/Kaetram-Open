...
export default class InputController {
    ...
    leftClick(position, keyMovement) {
        var self = this,
            player = self.getPlayer();
        ...
        if (self.entity) {
            ...
            if (self.isTargetable(self.entity)) player.setTarget(self.entity);

            if (
                player.getDistance(self.entity) < 7 &&
                player.isRanged() &&
                self.isAttackable(self.entity)
            ) {
