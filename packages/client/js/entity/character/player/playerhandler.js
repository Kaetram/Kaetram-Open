...
export default class PlayerHandler {
    ...
    load() {
        ...
        self.player.onStopPathing(function (x, y) {
            ...
            if (self.game.isDebug()) log.info('Stopping pathing.');
    ...
    checkBounds() {
        ...
        else if (x === self.camera.gridWidth - 2) self.game.zoning.setRight();
        else if (y === self.camera.gridHeight - 2) self.game.zoning.setDown();
