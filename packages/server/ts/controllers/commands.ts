        ...
        switch (command) {
            ...
            case 'pointer':
                ...
                if (blocks.length > 1) {
                    ...
                    this.player.send(new Messages.Pointer(Packets.PointerOpcode.Location, {
                    ...
                    this.player.send(new Messages.Pointer(Packets.PointerOpcode.NPC, {
                        id: instance
                    }));
                }
            ...
            case 'debug':
                this.player.send(new Messages.Command({
                    command: 'debug'
                }));
                return;
            ...
            case 'popup':
                ...
                this.player.send(new Messages.Notification(Packets.NotificationOpcode.Popup, {
